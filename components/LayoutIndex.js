      ...
      <div className="flex min-h-screen flex-col justify-between">
        ...
        <header className="container mb-16 md:mb-32  m-auto">
          ...
          <nav className="flex flex-col py-2  bg-white/80 backdrop-blur-md shadow-inner w-full fixed bottom-0 left-0 right-0 z-10 md:hidden">
            <div className="flex items-center overflow-x-auto overflow-y-hidden border-b border-gray-200 whitespace-nowrap dark:border-gray-700">
              <div>
                <ModalMenu />
              </div>
              <Link
                ...
                href="/profile"
              >
                <div className="flex justify-center mx-1text-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              {/* -----item2----- */}
              <div className="px-2 py-2 -mb-px text-center text-slate-700 bg-transparent border-b-4 border-transparent sm:px-4 -px-1 dark:text-white whitespace-nowrap cursor-base focus:outline-none hover:border-rose-700 hover:text-blue-600">
                <div className="flex cursor-pointer   gap-x-1 rounded-md  px-4 ">
                  <div className=" relative ">
                    <Link href="/cart">
                      <div className="flex justify-center">
                        {cartItemsCount > 0 && (
                          <span className="absolute -top-2 right-3 flex h-3 w-3  sm:h-5 sm:w-5  items-center  justify-center rounded-full bg-red-500 p-2 text-xs text-white">
                            {cartItemsCount}
                          </span>
                        )}
                        <svg
        ...
        <main className=" grid grid-cols-1 container px-4 mt-8 m-auto">
          ...
          <div>
            <h2 className="mt-4 mb-4 p-4 m-3 bg-rose-600 text-xl font-semibold  text-slate-50  lg:text-2xl dark:text-white rounded-lg shadow-md">
              پیشنهادات ویژه
            </h2>
            {children}
          </div>
          <div>
            <h2 className="mt-4 mb-4 p-4 m-3 border-2 border-rose-600 text-xl font-semibold  text-slate-800  lg:text-2xl dark:text-white rounded-lg shadow-md">
              جدیدترین محصولات
            </h2>
            {children}
          </div>
