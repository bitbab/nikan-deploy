            ...
            <div>
             ...
             <div>
              ...
              >
                ...
                <h1 className="mt-4 text-center text-xs sm:text-sm md:text-base lg:text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white">
                  لوازم جانبی
                </h1>
